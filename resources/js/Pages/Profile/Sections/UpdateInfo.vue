...
// by accepting user prop here on parent component now we have access to the user instance
...
// Manual visit to a route in Inertia
const resendEmail = (e) => {
...
<template>
    <Container class="mb-6">
        <div class="mb-6">
            ...
            <p>Update your account's profile information
                and email address.
            </p>
        </div>
        ...
        <form @submit.prevent="form.patch(route('profile.info'))" class="space-y-6">
            ...
            <!-- let's make this div conditional -->
